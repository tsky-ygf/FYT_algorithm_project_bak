...
class SfjHotNewsPipeline:
    ...
    def process_item(self, item, spider):
        ...
        insert_sql: str = """insert into hot_news.sfj_hot_news (uq_id,title,content,province,pubDate,url,htmlContent,category,source,question_type) 
