...
class PoliceHotNewsPipeline:
    ...
    def process_item(self, item, spider):
        ...
        insert_sql = """insert into hot_news.fy_hot_news (uq_id,title,content,province,pubDate,url,htmlContent,source,question_type,category) 
