...
def infer(args):
    ...
    state = torch.load(args.model_load_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_load_path", default='ContractNER/model_src/PointerBert/pBert0920_bs1.pt')
    ...
    pprint(args)
    tokenizer = BertTokenizer.from_pretrained('ContractNER/chinese-roberta-wwm-ext')
    ...
    args.input_test_text += """\n借条借款人姓名：孙林身份证号：孙林因生活所需，本人向叶芳（出借人）借到现金人民币（大写）叁仟伍佰圆整（￥3500元），且已经收到出借人支付的上述款项。签署时间：2022年2月1日借款人签字：借款人联系方式：15125822509保证人签名：保证人身份证号：511503197708235948保证人联系方式：13820935531"""
    print(len(args.input_test_text))
