...
名称：玫瑰单价：300元/斤数量：200斤金额：60000
名称：兰花单价：400元/斤数量：300斤金额：120000
名称：月季单价：100元/斤数量：100斤金额：10000
合计人民币金额（大写）：拾玖万元整
二、质量要求和验收
（一）质量要求
1、花卉晒干；
...
三、包装方式和要求
（一）包装方式和要求：纸箱包装
（二）包装物由甲方提供，费用由甲方承担，由乙方按合同约定的要求进行包装。
四、交付和货款支付
1、实行送货的，乙方应送至四川省成都市高港龚路Q座341330号。
2、交付之日，即时结清。
五、合同的变更
（一）交货时如市场价格高于或低于合同约定价格的4%，双方可对花卉价格进行重新协商。
（二）因气候发生重大变化或不可抗力等因素造成无法按合同约定的时间交货的，双方可另行协商。
六、违约责任
（一）交付的花卉质量不符合合同约定的，乙方应在3日内负责调换，无法按期调换的，应扣除不符合约定的花卉的相应价款，并按该价款的20%向甲方支付违约金；交付花卉的数量低于合同约定的，应在5天内负责补齐，无法在该期限补齐的，按欠交花卉花价款的20%向甲方支付违约金；交付的数量超出合同约定的，超出部分，甲方有权选择是否接收，甲方同意接收的，则按合同约定的单价计算。
（二）乙方延迟交货的，每延迟一日，应支付甲方约定批次价款额万分之五的违约金；甲方逾期提货的，每延迟一日，应支付该批次价款额万分之五的违约金。
（三）甲方不按约定收购霸王花的，应向乙方支付该批花卉价值的30%的违约金，并赔偿乙方因此遭受的损失。
（四）甲方逾期支付货款的，每延迟一日，应支付延迟货款额万分之五的违约金。
（五）因包装物质量不符合要求造成的损失由包装物提供方承担。
七、合同争议的解决
本合同在履行过程中发生的争议，双方协商解决，协商不成的，按下列第1种方式解决：
（一）提交中国广州仲裁委员会仲裁；
（二）依法向人民法院起诉。
