...
from ProfessionalSearch.SimilarCaseRetrieval.core.question_answering_ask_type_predict import (
    get_question_feature_label_prob,
    get_appeal_by_rules,
)
from ProfessionalSearch.SimilarCaseRetrieval.core.identify_problem_suqiu import (
    predict_problem_suqiu,
)



from ProfessionalSearch.SimilarCaseRetrieval.core.rank_util import (
    pseg_txt,
    inc_pos,
