...
import re
import time
from ProfessionalSearch.SimilarCaseRetrieval.core.rank_util import as_num
# 加载模型
base_path_fasttext='model/bxh_search_model/question_answering/bxh_identity_problem_and_suqiu.bin'
...
def predict_problem_suqiu(query,threshold=0.23): # 0.30
    ...
    predict_result_list=model.predict_proba([" ".join(jieba.lcut(query))],k=3)[0] #[0][0] #[0][0], k=3)
