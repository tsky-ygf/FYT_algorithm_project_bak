...
def generate_train_data(json_path, save_path):
    ...
    # pbar = tqdm(total=len(load_list))
        ...
        for one_judgment in f:
            ...
            words_split = item_i['words'].split('。')
            for words_split_item in words_split:
                if item_i['mention'] in words_split_item:
                    split_sentence.append({'words':words_split_item, 'labels':item_i['labels']})
        for one_judgment_new in split_sentence:
            # item_i = json.load(one_judgment_new)
            seg = distributed_preprocess_text_text(one_judgment_new)
...
if __name__ == '__main__':
    ...
    train_json_path = "data/fyt_cls_after/fasttext_loan/train.json"
    dev_json_path = "data/fyt_cls_after/fasttext_loan/dev.json"
    test_json_path = "data/fyt_cls_after/fasttext_loan/test.json"

    train_save_path = 'data/fyt_cls_after/fasttext_loan_file_form_changed/train_data_ner.txt'
    dev_save_path = 'data/fyt_cls_after/fasttext_loan_file_form_changed/dev_data_ner.txt'
    test_save_path = 'data/fyt_cls_after/fasttext_loan_file_form_changed/test_data_ner.txt'
