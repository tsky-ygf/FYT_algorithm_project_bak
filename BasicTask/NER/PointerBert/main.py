...
def main(args):
    ...
    # ===============================================================================
    state = torch.load("model/PointerBert/PBert1021_common_all_20sche_cat.pt")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_save_path", default='model/PointerBert/PBert1021_common_all_20sche_cat_aug.pt')
