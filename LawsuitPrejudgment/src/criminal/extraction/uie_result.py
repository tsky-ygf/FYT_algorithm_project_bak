...
from LawsuitPrejudgment.src.criminal.extraction.feature_extraction import get_xing7_result
from LawsuitPrejudgment.src.criminal.extraction.drug_extraction import get_drug_result
