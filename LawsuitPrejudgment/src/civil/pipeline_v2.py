...
from LawsuitPrejudgment.src.civil.nlu.factor_matching.recognization import single_case_match
from LawsuitPrejudgment.src.civil.reasoning_engine.logic_tree import LogicTree
from LawsuitPrejudgment.src.civil.reasoning_engine.precondition_process import get_next_suqiu_or_factor
from LawsuitPrejudgment.src.civil.utils.data_util import text_underline
...
from LawsuitPrejudgment.src.civil.nlg.predict_support_probability.bert_predict import predict as predict
...
class CivilPrejudgment(PrejudgmentPipeline):
    def __init__(self, *args, **kwargs):
        super(CivilPrejudgment, self).__init__(*args, **kwargs)
