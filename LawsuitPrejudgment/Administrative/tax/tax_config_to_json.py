...
with open("LawsuitPrejudgment/Administrative/tax/tax_config.json", "w", encoding="utf-8") as f:
    f.write(info_json)

pprint(type_dict)

type_json = json.dumps(type_dict, sort_keys=False, indent=4, ensure_ascii=False)
with open("LawsuitPrejudgment/Administrative/tax/tax_type.json", "w", encoding="utf-8") as f:
    f.write(type_json)
