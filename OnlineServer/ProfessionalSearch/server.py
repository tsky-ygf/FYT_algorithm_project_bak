...
def search_laws(search_query: Search_laws_input):
    return {"result": _get_law_result(search_query.query, search_query.filter_conditions, search_query.page_number, search_query.page_size)}
...
def search_laws(search_query: Search_cases_input):
    return {"result": _get_case_result(search_query.query, search_query.filter_conditions, search_query.page_number, search_query.page_size)}
